// Solucionador do desafio de proof-of-work de autoatendimento, para o gate integrado.
//
...
if (!challenge || !difficulty) {
  console.error("usage: self-service-solve-pow.mjs <challenge> <difficulty_bits>");
  process.exit(2);
}
