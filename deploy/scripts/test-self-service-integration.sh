...
echo "self-service PostgreSQL integration passed: unlimited-invite silent failure reproduced and fixed, invite targeting, stay provenance and approval invariants, pending account credential state, proof-of-work nonce ledger and the approval filter in the SECURITY DEFINER aggregate"
