...
export interface paths {
    ...
    "/accommodations/{accommodation_id}/calendar-feeds": {
         ...
         * @description Devolve os feeds ativos e suspensos com o estado da última sincronização. A URL do feed nunca aparece na resposta: ela é segredo portador, e quem a tem lê o calendário do anúncio inteiro (ADR-043).
         */
