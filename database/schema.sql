...
-- Camada de contexto externo (ADR-045). Espelho literal de
-- `apps/api/migrations/000005_external_context.up.sql`: o sqlc gera daqui, e
-- não da cadeia executável (ADR-032). A duplicação é deliberada e tem owner
-- único.
